<?php require('auth.php');?><html>
	...
	{
		$("#CAMERA").attr('src',"http://fatbot.internal.quantumsignal.com:8080/livestream/" + cam );
	...
	function updateStill( idx )
	{
		if ( idx != 0 )
		{
			$("#camera" + idx ).attr("src", "http://fatbot.internal.quantumsignal.com:8080/snapshot/" + cameraList[idx] + "?resolution=320x240&compression=75&rand="+Date.now() );
			var dt = new Date();
