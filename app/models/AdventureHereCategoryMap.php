 ...
 */
class AdventureHereCategoryMap extends DbModel {
    ...
    public string $here_category_id = '';
    ...
    {
        return 'adventure_here_category_map';
    }
    ...
    {
        return ['adventure_id', 'here_category_id'];
    }

    public function rules(): array
    {
        return [
            'adventure_id' => [self::RULE_REQUIRED],
            'here_category_id' => [self::RULE_REQUIRED]
        ];
    }
